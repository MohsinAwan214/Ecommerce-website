...
export default function Categories({darkMode}) {
  ...
  return (
    <div className={ `flex  gap-6 var  ${ darkMode ? "text-white " : ""} justify-center`}>
      <div className= {`h-28 w-32 bg-center flex-col gap-4 ${ darkMode ? "border-[#ffff] " : ""} border-[1px] border-[#0000004D]`}>
