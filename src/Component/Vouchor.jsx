...
export default function vouchor({ darkMode }) {
  return (
    <>
      <div className={`flex  w-full min-h-96 justify-between  voucher1  ${ darkMode ? "text-white" : ""} `}>
        ...
        <div className="h-80 flex  voucher2 w-[878px] justify-evenly mt-10 items-center bg-[#000000] overflow-hidden text-[#FAFAFA]">
          <div className=" flex flex-col h-full  gap-2 w-72  justify-center">
            <div className=" flex items-center gap-4">
              <RiAppleFill className="w-12 apple h-12" />
              <span className="text-[10px] iphone Poppins  pt-1">
                iPhone 14 Series
              </span>
            </div>
            <div className="font-semibold inter heading-2 text-[47px]  leading  w-full ">
